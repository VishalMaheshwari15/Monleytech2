...
const services = [
  {
    ...
    desc: 'Custom websites with SEO and modern tech stacks.',
    icon: '🌐',
    category: 'Web',
  },
  {
    title: 'Application Development',
    desc: 'Native and cross-platform mobile and web apps.',
    icon: '📱',
    category: 'App',
  },
  {
  ...
  {
    title: 'UI/UX Design',
    desc: 'Intuitive and user-centric design experiences.',
    icon: '🎨',
    category: 'Design',
  },
  {
  ...
  },
  {
    ...
    desc: 'SEO, social media, and content marketing strategies.',
    icon: '📣',
    category: 'Marketing',
  },
  {
    title: 'AI and Agentic Automation',
    desc: 'Advanced AI and autonomous agent solutions for business automation.',
    icon: '🤖',
    category: 'AI',
  },
];
...
const filterVariants = {
  active: { scale: 1.1, backgroundColor: '#10B981', color: '#111827' },
...
function ServicesSection() {
  ...
  return (
    <section
      className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-100/50 dark:from-gray-900 via-gray-800/50 dark:via-gray-800/50 to-gray-200/50 dark:to-gray-950 text-gray-900 dark:text-gray-100 font-inter relative overflow-hidden"
    ...
    >
      ...
      >
        <h2
          id="services-heading"
          className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight drop-shadow-lg"
        >
          Our{' '}
        ...
        <motion.p
          className="mt-6 text-lg sm:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed text-gray-600 dark:text-gray-300"
          variants={sectionVariants}
          transition={{ delay: 0.2 }}
        >
          Empower your business with MonkeyTech’s innovative services, crafted for growth and success.
        </motion.p>
      </motion.div>
      <nav
      ...
      >
        {categories.map((category) => (
          <motion.button
            ...
            className={`px-6 py-2 rounded-full border border-gray-300 dark:border-gray-600 text-sm font-semibold transition-all duration-300 ${
              filter === category
                ? 'bg-green-500 text-gray-900 shadow-md'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'
            } focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-900`}
      ...
      <motion.div
        className="fixed bottom-6 right-6 bg-gradient-to-r from-green-500 to-teal-400 text-gray-900 px-6 py-3 rounded-xl shadow-lg z-20 overflow-hidden"
      ...
      >
        <a
          href="/contact"
          className="text-sm font-semibold hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-green-500 relative z-10"
